...
export class Proevent extends Component {
    ...
    render() {
        return (
                ...
                <Header title='MY EVENTS' noLogo={true} nomap={true} noAdd={true} onImageClick={() => this.props.navigation.navigate('CreateEvent')} drawer  >
            <ScrollView>
            <View style={[Styles.container1, commonStyles.shadow]}>
                ...
                
                    {
                        this.props.userEvents.length ?
                            ...
                            <Sports sportdata={item} stat eventdetails={() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(Proevent)
