...
class Drawer extends Component {
    ...
    checkUser = async () => {
        {
            await Storage.getData('token').then(() => {
    ...
    renderTitle = (text, icon, route, params, logout) => (
        <TouchableOpacity
            ...
            <Text style={{ fontSize: dp(14), top: -3, color: '#FFF', width: '88%' }}>
                {text.toUpperCase()}
            </Text>
        </TouchableOpacity>
    );
            ...
            <LinearGradient
                ...
                <View style={{ width: '85%', alignSelf: 'center' }}>
                    {!this.state.pro ? (
                        <View
                            ...
                            {this.state.isEnabled ? (
                                <Text style={{ color: '#DDE2FF', marginRight: 12, marginTop: 6 }}>
                                    Available
                                </Text>
                            ) : (
                                    <Text style={{ color: '#DDE2FF', marginRight: 12, marginTop: 6 }}>
                    ...
                    <View
                        style={{
                            flexDirection: 'row',
                            marginTop: this.state.pro ? dp(25) : dp(1),
                            alignItems: 'center',
                        }}>
                        {/* User Image */}
                        ...
                        <View>
                            <Image
                                source={
                                    this.props.userProfile
                                        ? {
                                            uri:
                                                this.props.userProfile.image != null
                            ...
                            />
                            <Image
                                source={Images.yellowBadge}
                                style={{ position: 'absolute', bottom: 0, right: dp(10) }}
                            />
                        </View>
                        {/* User Details  */}
                    ...
                    <View
                        ...
                        <View
                            ...
                            />
                            <Text
                                style={{ color: '#6ABF0F', fontSize: dp(10), marginBottom: 6 }}>
                                Verified
              </Text>
                        </View>
                        {this.state.pro ? (
                    ...
                    {this.state.pro
                        ? null
                        : this.renderTitle('Home', Images.home, 'OrdinaryHome')}
                    {this.state.pro
                        ? this.renderTitle('My Events', Images.myEvent, 'Proevent')
                        : null}
                    {this.state.pro
                        ? null
