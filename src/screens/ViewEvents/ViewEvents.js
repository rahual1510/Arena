...
export class ViewEvents extends Component {
    ...
    render() {
        return (
            <Header title='VIEW EVENTS' noLogo={true} nomap={true} filter={true} onPressFilter={() => this.props.navigation.navigate('Filter')} back={true} onBackPress={() => this.props.navigation.goBack()} search placeholderText={'Search'} fnc={(sval)=>this.filter(sval)}  >
                        ...
                        <View style={{
                            ...
                            <Text onPress={() => {
                                ...
                                style={{
                                    ...
                                    fontWeight: '700', paddingBottom: 10
                                }}>{strings.arena} {strings.events}</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text onPress={() => {
                                ...
                                style={{
                                    ...
                                    fontWeight: '700', paddingBottom: 10
                                }}>{strings.pro} {strings.events}</Text>
                        </View>
