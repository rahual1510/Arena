        ...
        await WebApi.getParticipant(id)
            .then(response => {
                ...
                if (!response) {
                    ...
                    const age = birthday.split(' ')[0];
                    if (age != 'Invalid') {
                        this.setState({ age: birthday.split(' ')[0] })
                    } else {
                        var m = moment(response.data.date_birth, 'DD-MM-YYYY');
                        var years = moment().diff(m, 'years', false);
                        this.setState({ age: years, list: response.data })
                    }
                        ...
                        <View style={{ flex: 1, padding: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', width: '100%', alignItems: 'center' }}>
                                ...
                                <View style={{ flex: 1, alignItems: 'center', position: 'absolute', width: '100%' }}>
                                    <Text style={{ fontWeight: '600', color: '#ffffff', fontSize: 15, textAlign: 'center' }}>PROFILE</Text>
                                </View>
                            ...
                            <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: '15%', marginBottom: -20 }}>
                                ...
                                <View style={styles.outerBox}>
                                    ...
                                    <Text style={styles.Simpletext}>
                                        {this.state.list.city + ', ' + this.state.list.city}
                                    </Text>
